...
const App = () => {
    ...
    return (
        <div>
            <h1 style={{ color: 'black', fontSize: 40, marginBottom: "20px" }}>Phone book</h1>
            ...
            <h2 style={{ color: 'black', fontSize: 30, marginBottom: "20px" }}>Add a new</h2>
            <AddPersonForm
                addPerson={addPerson}
                ...
                phone={phone}
            />
            <h2 style={{ color: 'black', fontSize: 30, marginBottom: "20px" }}>Numbers</h2>
            <ul>
